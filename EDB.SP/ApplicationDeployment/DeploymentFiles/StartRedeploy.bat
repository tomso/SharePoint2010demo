...
:START
%msbuildversion% Deployment.msbuild /target:%target% /noconsolelogger /logger:UILogger,MSBuild/SPALM.MSBuildTasks.dll /logger:ULSFormatLogger,MSBuild/SPALM.MSBuildTasks.dll;logfile=%logfile%;Verbosity=diagnostic /nologo /verbosity:%verbosity%
